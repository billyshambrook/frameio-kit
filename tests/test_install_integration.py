"""Tests for installation system integration with App class."""
...
class TestAppIntegration:
    """Test installation system integration with App."""

    def test_app_without_installation(self, oauth_config):
    ...
    def test_app_with_installation(self, oauth_config, installation_config):
    ...
    def test_app_installation_without_oauth(self, installation_config):
    ...
    def test_installation_routes_added(self, oauth_config, installation_config):
    ...
    def test_manifest_auto_discovery(self, oauth_config, installation_config):
    ...
    def test_manifest_filtering(self, oauth_config, installation_config):
    ...
    def test_installation_manager_accessible(self, oauth_config, installation_config):
        """Test that installation manager is accessible via property."""
        app = App(
            token="test_token",
            oauth=oauth_config,
            installation=installation_config,
        ...
        # Should be able to access installation manager
        manager = app.installation_manager
        assert manager is not None
        assert manager.manifest is not None
        assert manager.storage is not None

    def test_installation_manager_not_accessible_without_config(self, oauth_config):
        """Test that installation manager raises error when not configured."""
        app = App(
            token="test_token",
            oauth=oauth_config,
        )
        ...
        # Should raise error
        with pytest.raises(RuntimeError, match="Cannot access installation manager"):
            _ = app.installation_manager
